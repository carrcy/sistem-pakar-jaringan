...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
      <div class="row d-flex align-items-center justify-content-center custom-layout">
        ...
        <div class="col-lg-6 text-center text-lg-start order-2 order-lg-1 mb-4 mb-lg-0">
          ...
          <button type="button" class="btn btn-success rounded-pill px-4 py-2 font-monospace shadow-sm">
            Netsolver siap membantu Anda!
          </button>
        </div>
        <!-- Kolom Gambar -->
    ...
    <div class="container w-100 w-md-75 w-lg-50">
      ...
      <!-- Tambahkan item berikutnya dengan format yang sama -->
